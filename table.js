...
function GlobalFilter({
  ...
  return (
    <div>
      <span>
        <RiSearchEyeLine className="inline" /> Search:
        <input
          value={value || ""}
          onChange={(e) => {
                    ...
                    {type === "doctor" ? (
                      <div className="dropdown-content">
                        <Link to="/doctor-detail">
                          <BsInfoCircle className="inline mr-3 info-icon" />
                          <button onClick={() => viewDoctor(row.original._id)}>
                            View Details
                          </button>
                        </Link>
                        <Link to="/doctor-list">
                          <BiEdit className="inline mr-3 edit-icon" /> Edit
                        </Link>
                        {/* <Link to="/doctor-list"> */}
                        <Link>
                          <RiDeleteBin7Line className="inline mr-3 delete-icon" />
                          <button
                            onClick={() => deleteDoctor(row.original._id)}
                          >
                            Delete
                          </button>
                        </Link>
                      ...
                      <div className="dropdown-content">
                        <Link to="/patient-list">
                          <BsCheckCircle className="inline mr-3 accept-icon" />
                          Accept Patient
                        </Link>
                        <Link to="/patient-list">
                          <BsXCircle className="inline mr-3 reject-icon" />
                          Reject Patient
                        </Link>
                        <Link to="/patient-detail">
                          <BsInfoCircle className="inline mr-3 info-icon" />
                          <button
                            onClick={() => viewPatients(row.original._id)}
                          >
                            View Details
                          </button>
                        </Link>
                      ...
                      <div className="dropdown-content">
                        ...
                        <Link to="/specialty-list">
                          ...
                          <RiDeleteBin7Line className="inline mr-3 delete-icon" />
                          <button
                            onClick={() => deleteSpeciality(row.original._id)}
                          >
                            Delete
                          </button>
                        </Link>
